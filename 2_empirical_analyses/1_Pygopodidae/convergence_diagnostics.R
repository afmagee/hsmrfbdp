...
# Get HSRF analyses
hsrf1 <- read.table("2_empirical_analyses/output/Pygopodidae_HSMRFBDP_1.log",header=TRUE,row.names=1)
hsrf2 <- read.table("2_empirical_analyses/output/Pygopodidae_HSMRFBDP_2.log",header=TRUE,row.names=1)
hsrf3 <- read.table("2_empirical_analyses/output/Pygopodidae_HSMRFBDP_3.log",header=TRUE,row.names=1)
hsrf4 <- read.table("2_empirical_analyses/output/Pygopodidae_HSMRFBDP_4.log",header=TRUE,row.names=1)

# Get GMRF analyses
gmrf1 <- read.table("2_empirical_analyses/output/Pygopodidae_GMRFBDP_1.log",header=TRUE,row.names=1)
gmrf2 <- read.table("2_empirical_analyses/output/Pygopodidae_GMRFBDP_2.log",header=TRUE,row.names=1)
...
# ESS
hsrf.ess <- rankESS(list(hsrf1,hsrf3,hsrf4))
gmrf.ess <- rankESS(list(gmrf1,gmrf2,gmrf3,gmrf4))
